...
//---------------------------------------------------------------------------------------------//
  ...
  double RELATIVE_HOSPITALIZATION_ALPHA=1.35;
  double RELATIVE_HOSPITALIZATION_DELTA=1.35;
  double RELATIVE_HOSPITALIZATION_OMICRON=.1;
  double RELATIVE_HOSPITALIZATION_OMICRON_NEW=.1;
  double RELATIVE_HOSPITALIZATION_OMICRON_BA4=.1;
  double RELATIVE_HOSPITALIZATION_OMICRON_BA5=.1;
  double RELATIVE_HOSPITALIZATION_OMICRON_BA6=.1;
  double RELATIVE_HOSPITALIZATION_OMICRON_BA7=.1;
  double RELATIVE_HOSPITALIZATION_OMICRON_BA8=.1;
