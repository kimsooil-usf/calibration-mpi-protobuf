...
LDLIBS = -lprotobuf 
LDFLAGS = -L/mnt/lustre/rbc/rbcsri/bin/lib/
include_paths = -Ilibs/ -Ilibs/cxxopts-2.2.0/include/ -I../../bin/lib -I../../protobuf-3.13.0/src/
...
CXX = g++
CPPFLAGS = -Wall --std=c++1y -O3 $(DEPFLAGS) $(include_paths) $(parallel) $(timing) $(debug) $(random) -D GIT_HASH='"$(GIT_HASH)"' -D GIT_TREE_STATE='"$(GIT_TREE_STATE)"'
