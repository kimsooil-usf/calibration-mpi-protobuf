    ...
    for nsd in range(1,PIECE+1):
        ...
        for connect in range(num_connect):
            ...
            if remain_params != 0 and connect == num_connect-1:
                ...
                command = "mpirun -map-by node --hostfile /largedisk/mpi-test/host_file16_3 -np " + str(remain_params) + " \
            ...
            # All other simulations
                ...
                command = "mpirun -map-by node --hostfile /largedisk/mpi-test/host_file16_3 -np " + str(NPROCESSORS) + " \
